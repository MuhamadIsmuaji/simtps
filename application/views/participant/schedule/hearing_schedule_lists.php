                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $value->ruang ?></td>
                                    <td>
                                        <a href="<?= base_url('participant/schedule/hearingScheduleDetail/'.$value->thn_ajaran.'/'.$value->smt.'/'.$value->ruang.'/'.$value->tgl.'/'.$value->mulai.'/'.$value->akhir)?>" class="btn btn-primary" target="_blank">
